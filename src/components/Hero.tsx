  ...
  return (
    <div className="px-5 flex overflow-hidden relative flex-col items-center self-stretch w-full py-4 max-md:max-w-full">
      ...
      <div className=" flex justify-center items-center content-center align-middle flex-col ">
        <div className="relative mt-32 text-7xl font-bold text-center  w-full text-gray-900 max:w-[947px] max-md:mt-10 max-md:max-w-full max-md:text-4xl">
        ...
        <div className="relative mt-8 text-base font-medium leading-7 text-center text-gray-900 w-full max-w-[748px] max-md:max-w-full">
        ...
        <div className="relative gap-2  rounded-lg px-4 py-4 mt-12 text-base font-semibold tracking-widest leading-none text-white bg-primary  min-h-[48px] max-md:mt-10 w-fit">
          Book a Demo
        </div>
      ...
      <img
        ...
        className="object-cover  inset-0 size-full max-w-[628px] rounded-lg mt-[91px]"
      />
    </div>
  );
};
