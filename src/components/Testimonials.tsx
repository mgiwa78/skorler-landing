  ...
  return (
    <div className="lg:py-24 overflow-hidden py-10 px-5 bg-surface-light justify-center items-center flex flex-col">
      ...
      <div className="flex relative z-40 flex-col mt-10 mb-10 lg:mb-32 w-full text-center text-gray-900 max-w-[765px]">
        ...
        <div className="self-center mt-3 text-base  font-manrope leading-7 max-md:max-w-full">
          Join the teams who rely on Skorler to provide world-class
          collaboration and project management for their academic and
          professional endeavors.
        </div>
      </div>
      <div className="relative  flex z-10 flex-col lg:px-20 mb-16 pb-0 mt-0 w-full font-semibold text-center max-md:px-5 max-md:pb-24 max-md:max-w-full">
        <div className="flex z-10  flex-wrap gap-5 justify-center w-full items-center max-md:max-w-full">
          <div className="flex relative overflow-hidden justify-between flex-col items-center self-stretch px-12 py-11 my-auto rounded-2xl bg-surface-light border-borderColor-light border-[1px] min-w-[240px] min-h-[434px] w-full max-w-[413px] max-md:px-5">
            <div className="self-start text-2xl leading-8 text-gray-900  font-manrope">
            ...
            <img
              ...
              alt=""
            />
            <div className=" flex gap-[13px] flex-col justify-center items-center  font-manrope self-center mt-5 text-lg  leading-7 text-slate-600 w-full max-w-[311px]">
              <img className="   " src="/icons/ellipse_18.svg" alt="" />
              Dr. Jane Smith, University of Academic Excellence
            </div>
          </div>
          <div className="flex relative overflow-hidden justify-between flex-col items-center self-stretch px-12 py-11 my-auto rounded-2xl bg-surface-light border-borderColor-light border-[1px] min-w-[240px] min-h-[434px] w-full max-w-[413px] max-md:px-5">
            <div className="self-stretch text-2xl leading-8 text-gray-900  font-manrope">
            ...
            <img
              ...
              alt=""
            />
            <div className=" flex gap-[13px] flex-col justify-center items-center  font-manrope   mt-5 text-lg leading-7  text-slate-600">
